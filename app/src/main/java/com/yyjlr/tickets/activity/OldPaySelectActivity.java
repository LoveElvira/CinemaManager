 ...
 * 支付界面
 */
public class OldPaySelectActivity extends AbstractActivity implements View.OnClickListener, CountdownView.OnCountdownEndListener {
...
//            startRefreshTime();
    ...
    private void addPackageList(List<OrderItemsInfo> orderItemsInfoList) {
        for (int i = 0; i < orderItemsInfoList.size(); i++) {
            View view = LayoutInflater.from(OldPaySelectActivity.this).inflate(R.layout.item_pay_select_film_sale, addPackageLayout, false);
        ...
        OkHttpClientManager.postAsyn(Config.CANCEL_ORDER, new OkHttpClientManager.ResultCallback<ResponeNull>() {
            ...
            public void onResponse(ResponeNull response) {
                ...
                setResult(CODE_RESULT, new Intent()
                        .putExtra("isCancel", true)
                        .putExtra("position", position));
                OldPaySelectActivity.this.finish();
            }
...
//                showShortToast(exception.getMessage());
        ...
        }, idRequest, ResponeNull.class, OldPaySelectActivity.this);
    }
...
//                cardLine.setVisibility(View.VISIBLE);
    ...
    private void showCancelPay() {
        LayoutInflater inflater = LayoutInflater.from(OldPaySelectActivity.this);
        View layout = inflater.inflate(R.layout.alert_dialog, null);
        final AlertDialog builder = new AlertDialog.Builder(OldPaySelectActivity.this).create();
