...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mChildClickListener != null)
                mChildClickListener.onItemChildClick(BaseAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderLayoutCount());
        }
    }
    ...
    public class OnItemChildLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            if (mChildLongClickListener != null) {
                return mChildLongClickListener.onItemChildLongClick(BaseAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderViewsCount());
            }
            return false;
        }
    }
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.footer_loading);
        }
