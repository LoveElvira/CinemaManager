...
public class OldCouponContent extends BaseLinearLayout implements BaseAdapter.RequestLoadMoreListener, SuperSwipeRefreshLayout.OnPullRefreshListener, BaseAdapter.OnRecyclerViewItemChildClickListener {
    ...
    public OldCouponContent(Context context) {
        super(context);
    }

    public OldCouponContent(Context context, AttributeSet attrs) {
        super(context, attrs);
            ...
            public void onResponse(CouponBean response) {
                if (response != null) {
                    ...
                    if (couponList != null && couponList.size() > 0) {
                        ...
                        adapter.setOnLoadMoreListener(OldCouponContent.this);
