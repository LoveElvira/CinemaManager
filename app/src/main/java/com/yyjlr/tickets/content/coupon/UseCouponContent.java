...
import com.yyjlr.tickets.adapter.UseCouponAdapter;
...
public class UseCouponContent extends BaseLinearLayout implements SuperSwipeRefreshLayout.OnPullRefreshListener, BaseAdapter.RequestLoadMoreListener, BaseAdapter.OnRecyclerViewItemChildClickListener {

    private UseCouponAdapter adapter = null;
    ...
    public UseCouponContent(Context context) {
        super(context);
    }

    public UseCouponContent(Context context, AttributeSet attrs) {
        super(context, attrs);
            ...
            public void onResponse(CouponBean response) {
                if (response != null) {
                    ...
                    if (couponList != null && couponList.size() > 0) {
                        ...
                        adapter.setOnLoadMoreListener(UseCouponContent.this);
